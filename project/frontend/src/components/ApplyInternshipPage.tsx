...
const ApplyInternshipPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const found = internships.find((i: any) => String(i.id) === String(internshipId));
    setInternship(found || null);
  }, [internshipId]);

  if (!user || user.userType !== 'student') {
    return <div className="flex flex-col items-center justify-center min-h-screen"><h2 className="text-2xl">Only students can apply for internships.</h2></div>;
  }
  if (!internship) {
    return <div className="flex flex-col items-center justify-center min-h-screen"><h2 className="text-2xl">Internship not found.</h2></div>;
  }
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-xl mx-auto">
          <div className="mb-4">
            ...
            <div className="text-gray-700">{internship.type} | Duration: {internship.duration}</div>
          </div>
